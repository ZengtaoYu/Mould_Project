/********************************************************************************
** Form generated from reading UI file 'warehouseout.ui'
**
...
#ifndef UI_WAREHOUSEOUT_H
#define UI_WAREHOUSEOUT_H
...
public:
    ...
    void setupUi(QMainWindow *WarehouseOut)
    {
        if (WarehouseOut->objectName().isEmpty())
            WarehouseOut->setObjectName(QString::fromUtf8("WarehouseOut"));
        WarehouseOut->resize(580, 410);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(WarehouseOut->sizePolicy().hasHeightForWidth());
        WarehouseOut->setSizePolicy(sizePolicy);
        WarehouseOut->setMinimumSize(QSize(580, 410));
        WarehouseOut->setMaximumSize(QSize(580, 410));
        centralwidget = new QWidget(WarehouseOut);
...
"}"));
        ...
        OutTime->setGeometry(QRect(310, 260, 251, 41));
...
"}"));
        ...
        OutButton->setGeometry(QRect(360, 320, 91, 41));
        QFont font1;
...
"}"));
        ...
        OutNum->setGeometry(QRect(270, 320, 61, 41));
...
"}"));
        ...
        WarehouseOut->setCentralWidget(centralwidget);
        BackGround->raise();
        SpareView->raise();
        Label1->raise();
        Label6->raise();
        ...
        ChangeButton->raise();
        MoldCombo->raise();
        menubar = new QMenuBar(WarehouseOut);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 580, 23));
        WarehouseOut->setMenuBar(menubar);
        statusbar = new QStatusBar(WarehouseOut);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        WarehouseOut->setStatusBar(statusbar);
        QWidget::setTabOrder(ChangeButton, MoldCombo);
        QWidget::setTabOrder(MoldCombo, SpareView);
        QWidget::setTabOrder(SpareView, SpareEdit);
        QWidget::setTabOrder(SpareEdit, CabinetEdit);
        QWidget::setTabOrder(CabinetEdit, OutTime);
        QWidget::setTabOrder(OutTime, OutNum);
        QWidget::setTabOrder(OutNum, OutButton);
        QWidget::setTabOrder(OutButton, ReturnButton);
        QWidget::setTabOrder(ReturnButton, ExportButton);

        retranslateUi(WarehouseOut);

        QMetaObject::connectSlotsByName(WarehouseOut);
    } // setupUi

    void retranslateUi(QMainWindow *WarehouseOut)
    {
        WarehouseOut->setWindowTitle(QCoreApplication::translate("WarehouseOut", "MainWindow", nullptr));
        Label1->setText(QCoreApplication::translate("WarehouseOut", "\346\200\273\345\272\223\345\255\230\351\207\217:", nullptr));
        Label6->setText(QCoreApplication::translate("WarehouseOut", "\345\207\272\345\272\223\346\227\266\351\227\264:", nullptr));
        OutTime->setPlaceholderText(QCoreApplication::translate("WarehouseOut", "yyyy-MM-dd hh:mm:ss", nullptr));
        Label5->setText(QCoreApplication::translate("WarehouseOut", "\345\255\230\346\224\276\346\237\234\345\217\267:", nullptr));
        OutButton->setText(QCoreApplication::translate("WarehouseOut", "\345\207\272\345\272\223", nullptr));
        TotalNum->setText(QString());
        ReturnButton->setText(QCoreApplication::translate("WarehouseOut", "\350\277\224\345\233\236", nullptr));
        BackGround->setText(QString());
        LogoLabel->setText(QString());
        SaveNum->setText(QString());
        Label2->setText(QCoreApplication::translate("WarehouseOut", "\345\256\211\345\205\250\345\272\223\345\255\230:", nullptr));
        Label4->setText(QCoreApplication::translate("WarehouseOut", "\345\244\207\344\273\266\345\217\267:", nullptr));
        Label7->setText(QCoreApplication::translate("WarehouseOut", "\346\225\260\351\207\217:", nullptr));
        Label3->setText(QCoreApplication::translate("WarehouseOut", "\351\200\211\346\213\251\345\206\262\345\216\213\345\244\207\344\273\266\342\254\213", nullptr));
        ExportButton->setText(QCoreApplication::translate("WarehouseOut", "\350\256\260\345\275\225", nullptr));
        ChangeButton->setText(QCoreApplication::translate("WarehouseOut", "\345\210\207\346\215\242\344\270\272\346\210\220\345\236\213\345\244\207\344\273\266", nullptr));
    } // retranslateUi

};

namespace Ui {
    class WarehouseOut: public Ui_WarehouseOut {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WAREHOUSEOUT_H
