...
QT_MOC_LITERAL(4, 48, 22) // "on_EmailButton_clicked"

    },
    "AdminWindow\0enablesignal\0\0"
...
void AdminWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AdminWindow::enablesignal)) {
                *result = 0;
                return;
            }
        }
